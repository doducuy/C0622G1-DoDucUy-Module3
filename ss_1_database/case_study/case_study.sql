...
use case_study;
create table vi_tri( ma_vi_tri int primary key auto_increment , ten_vi_tri varchar(45));
insert into vi_tri values (1,"truong phong");
insert into vi_tri (ten_vi_tri) values ("nhan vien");
-- delete from vi_tri where ma_vi_tri =1;
select* from vi_tri;
create table trinh_do(ma_trinh_do int primary key, ten_bo_phan varchar(45));
create table bo_phan(ma_bo_phan int primary key, ten_bo_phan varchar(45));
create table loai_khach(ma_loai_khach int primary key, ten_loai_khach varchar(45));
create table loai_dich_vu(ma_loai_dich_vu int primary key, ten_loai_dich_vu varchar(45));
create table kieu_thue(ma_kieu_thue int primary key, ten_kieu_thue varchar(45));
